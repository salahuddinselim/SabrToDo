...
export default function Home() {
  return (
    <div className="min-h-screen">
      <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-cyan-100/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/auth/login"
                className="text-slate-300 hover:text-cyan-100 transition-colors font-medium"
              >
                Log in
              </Link>
              <Link
                href="/auth/signup"
                className="px-4 py-2 rounded-xl gradient-bg text-white font-semibold hover:shadow-lg hover:shadow-primary/40 transition-all"
              >
                Get Started
              </Link>
            </div>
      ...
      <main>
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 animate-fade-in">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-slide-up">
              ...
              <span className="text-sm text-slate-200">A calm, modern workspace for focus</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-display font-extrabold text-white mb-6 leading-tight animate-slide-up">
              Build momentum without{' '}
              <span className="gradient-text">productivity</span>
              <br className="hidden sm:block" /> burnout.
            </h1>

            <p className="text-xl text-slate-300/90 mb-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up">
              ...
              <Link
                href="/auth/login"
                className="flex items-center gap-2 px-8 py-4 rounded-2xl glass text-slate-200 font-semibold text-lg hover:bg-slate-900/35 transition-all"
              >
                Sign in
              </Link>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="glass rounded-3xl p-6 hover:shadow-xl hover:shadow-cyan-950/40 transition-all animate-slide-up"
        ...
        <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-cyan-100/15">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <Logo size="sm" className="w-8 h-8 rounded-lg shadow-md" />
                <span className="font-semibold text-slate-200">SabrFlow by SabrWare</span>
              </div>
